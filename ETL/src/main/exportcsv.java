...
public class exportcsv {
    ...
    private static String lease_canceldate = "";
    private static String lease_enddate = "";
...
//			}
			...
			while(resultSetOracle.next()){
				...
				out.print(resultSetOracle.getInt("新車販売売上高"));out.print("\",\"");
				out.print(resultSetOracle.getInt("中古車販売売上高"));out.print("\",\"");
				out.print(resultSetOracle.getInt("サービス部品売上高"));out.print("\",\"");
				out.print(resultSetOracle.getInt("保険売上高"));out.print("\",\"");
				out.print(resultSetOracle.getInt("入庫回数"));out.print("\",\"");
				out.print(resultSetOracle.getInt("新車販売粗利"));out.print("\",\"");
				out.print(resultSetOracle.getInt("中古車販売粗利"));out.print("\",\"");
				out.print(resultSetOracle.getInt("サービス部品粗利"));out.print("\",\"");
				out.print(resultSetOracle.getInt("保険粗利"));out.print("\",\"");
...
//			}
			...
			while(resultSetOracle.next()){
				...
				out.print(resultSetOracle.getInt("最新入庫日"));out.print("\",\"");
...
//			}
			...
			while(resultSetOracle.next()){
				...
				out.print(resultSetOracle.getInt("リース終了年月日"));out.print("\",\"");
				out.print(resultSetOracle.getInt("リース解約年月日"));out.print("\",\"");
